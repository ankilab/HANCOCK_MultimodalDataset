...
> [!NOTE]
> This section describes the optional process of using the TMA files provided in the HANCOCK data set, along with the 
> TMA Maps also provided, to extract TMA cores and perform immune cell counting.
