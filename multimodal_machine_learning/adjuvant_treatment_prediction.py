...
class AdjuvantTreatmentPredictor:
    def __init__(self):
        self.argumentParser = HancockArgumentParser(type="adjuvant_treatment_prediction")
    
    def _prepare_necessary_data(self):
        self._dataFrameReaderFactory = DataFrameReaderFactory()
        # ToDo: We need a feature reader for each data type. 
